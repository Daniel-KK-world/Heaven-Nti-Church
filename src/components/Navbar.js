...
function Navbar() {
  return (
    <header className="w-100">
      {/* Top Strip */}
      <div className="bg-dark text-light small px-4 py-1 d-flex justify-content-between align-items-center text-center navedit">
      ...
      <nav className="navbar navbar-expand-md navbar-light bg-white shadow-sm px-4 py-3 sticky-top">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            ...
            {/* CTA */}
            <a href="https://youtube.com/@hntvgh157?si=YdWS950jqrHK07qq" className="btn btn-danger text-white px-4 py-2 rounded-pill fw-semibold">
              Revelator Show
            </a>
          </div>
        </div>
